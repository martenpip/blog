    ...
    <div class="join">
        ...
        @foreach ($elements as $element)
            ...
            @if (is_string($element))
                <a class="join-item btn btn-disabled" aria-disabled="true">{{$page}}</a>
            @endif
        ...
        @if ($paginator->hasMorePages())
            <a class="join-item btn" rel="next" aria-label="@lang('pagination.next')">&lsaquo;</a>
        @else
            <a class="join-item btn btn-disabled" aria-disabled="true" aria-label="@lang('pagination.next')"
               aria-hidden="true">&lsaquo;</a>
            @endif
    </div>
@endif
